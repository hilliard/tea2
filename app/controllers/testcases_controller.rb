class TestcasesController < ApplicationController
  ...
  private
    ...
    def testcase_params
      params.require(:testcase).permit(:tctitle, :tcdescription, :tcprecondition, :tcdata, :tcexpectedresults, :tcsubsystem, :tcstatus, :tcpostcondition, :tcauthor, :tcactive, :tcreqreference, :tcmodifiedby, :tcexecdate, :tcstarttime, :tcstoptime, :tcstep)
    end
end
